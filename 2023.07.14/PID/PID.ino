...
#define encoderPinB       2     // encoder B상 핀번호
#define encoderPinA       3     // encoder A상 핀번호
#define motor_DIR         4
#define motor_PWM         5
#define servoPin          8     // servo 핀번호
...
void setup() {
  ...
  Steeringservo.attach(servoPin);     //서보 작동
...
void loop() { 
  ...
  //if (millis() % 20 == 0)      digitalWrite(servoPin, HIGH);
  //else if (millis() % 20 == (0.2 * 50))     digitalWrite(servoPin, LOW);
